...
"""
`poly`
The poly tool returns the coefficients of a polynomial with the given sequence
of roots.
...
`polyfit`
The polyfit tool fits a polynomial of a specified order to a set of data
